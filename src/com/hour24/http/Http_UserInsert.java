...
public class Http_UserInsert extends AsyncTask<String, String, String> {
	...
	public Http_UserInsert(Activity activity, String phone, String device) {
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			HttpPost post = new HttpPost(Element.URL + "/UserInsert");

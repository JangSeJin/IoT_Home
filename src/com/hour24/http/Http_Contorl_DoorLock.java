...
public class Http_Contorl_DoorLock extends AsyncTask<String, String, String> {
	...
	public Http_Contorl_DoorLock(Activity activity, String turn) {
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			HttpPost post = new HttpPost(Element.URL + "/DoorlockHttp");

			List<NameValuePair> pairs = new ArrayList<NameValuePair>();
			pairs.add(new BasicNameValuePair("type", "doorlock"));
			pairs.add(new BasicNameValuePair("turn", turn + ""));
			pairs.add(new BasicNameValuePair("phone", Element.PHONE));
			// pairs.add(new BasicNameValuePair("imei", Element.IMEI));

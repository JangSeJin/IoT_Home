...
public class Http_Control_Motion extends AsyncTask<String, String, String> {
	...
	public Http_Control_Motion(Activity activity, boolean flag) {
	...
	protected String doInBackground(String... params) {
		...
		try {
			...
			HttpPost post = new HttpPost(Element.URL + "/MotionHttp");

			List<NameValuePair> pairs = new ArrayList<NameValuePair>();
			pairs.add(new BasicNameValuePair("turn", flag + ""));
